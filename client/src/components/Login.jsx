...
const Login = () => {
  ...
  return (
    <div className='absolute top-0 right-0 left-0 bottom-0 z-10 backdrop-blur-sm bg-blck/30 flex justify-center 
    items-center'>
        ...
        className='relative bg-white p-10 rounded-xl text-slate-500'>
            ...
            <button className='bg-blue-600 w-full text-white py-2 rounded-full'>{state === 'Login' ? 'Login'
